  ...
  if (authLoading || (!isAdmin && user)) {
    return (
      <div className="flex items-center justify-center min-h-[calc(100vh-100px)]">
        <LoadingSpinner message="Redirecting to your school portal..." />
      </div>
    );
  }
                              ...
                              <div className="text-[11px] text-slate-500 space-y-1 pb-4">
                                <p className="truncate flex items-center gap-1.5">
                                  <span><HugeiconsIcon
                                    ...
                                    color="#bd10e0"
                                    strokeWidth={1.5}
                                  /></span> <span className="font-medium text-slate-600">{school.phone}</span>
                                </p>
                                <p className="truncate flex items-center gap-1.5">
                                  <span>
                                    <HugeiconsIcon
                                      ...
                                      strokeWidth={1.5}
                                    />
                                  </span> <span className="truncate" title={school.address}>{school.address}</span>
                                </p>
                              </div>
                            </div>
