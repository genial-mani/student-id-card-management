    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b border-gray-700/60">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-white font-bold text-base leading-none">Student ID</p>
            <p className="text-blue-400 text-xs font-medium mt-0.5">Management System</p>
          </div>
          {/* Mobile close */}
          <button
            onClick={close}
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-1">
        ...
        {schools.length === 0 && (
          <p className="text-xs text-gray-500 text-center py-4">
            {user?.role === "admin" ? "No schools yet. Create one above." : "No schools assigned."}
          </p>
        )}
        ...
        {schools.map((school) => (
          <Link
            ...
            onClick={close}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-700/60 transition-colors group"
          >
            {school.logoUrl ? (
              <Image
                src={school.logoUrl}
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-3 left-3 z-40 bg-gray-800 text-white p-2 rounded-xl shadow-lg border border-gray-700"
      ...
      {/* Mobile drawer */}
      <div
        className={`lg:hidden fixed top-0 left-0 h-full w-64 bg-gray-800 z-50 transition-transform duration-300 ${
